...
const STRINGS = {
  en: {
    ...
    dashboard: 'Dashboard', new_household: 'New Entry', households: 'Houses',
    users: 'Field Team', reports: 'Reports',
    // new fields / UI
    gender: 'Gender', male: 'Male', female: 'Female',
    house_ownership: 'House', own: 'Own', rented: 'Rented', booth_na: '0 - NA',
    mark_special: 'Mark Special', special_list: 'Special List', all_residents: 'All Houses',
    ...
    all_houses: 'All Houses', delete_entry: 'Delete', confirm_delete_title: 'Delete this entry?',
    confirm_delete_body: 'This permanently removes this house and all its voters. This cannot be undone.',
    yes_delete: 'Yes, Delete', add_another: 'Add Another', done_field_team: 'Done — Field Team',
    created_ok: 'Created', back: 'Back',
    allow_special: 'Allow Special', hide_special: 'Hide Special', sees_special: 'sees special',
    open_in_maps: 'Open in Google Maps', access_label: 'Access',
    permissions_label: 'Permissions', see_mobile: 'Can see Mobile', see_special: 'Can see Special List',
    ...
    // form
    household_details: 'House Details',
    ...
    sync_now: 'Sync now',
    // dashboard
    total_households: 'Houses', total_voters: 'Voters',
  ...
  kn: {
    ...
    dashboard: 'ಡ್ಯಾಶ್‌ಬೋರ್ಡ್', new_household: 'ಹೊಸ ನಮೂದು', households: 'ಮನೆಗಳು',
    ...
    mark_special: 'ವಿಶೇಷ ಗುರುತಿಸಿ', special_list: 'ವಿಶೇಷ ಪಟ್ಟಿ', all_residents: 'ಎಲ್ಲಾ ಮನೆಗಳು',
    ...
    all_houses: 'ಎಲ್ಲಾ ಮನೆಗಳು', delete_entry: 'ಅಳಿಸಿ', confirm_delete_title: 'ಈ ನಮೂದನ್ನು ಅಳಿಸುವುದೇ?',
    confirm_delete_body: 'ಇದು ಈ ಮನೆ ಮತ್ತು ಎಲ್ಲಾ ಮತದಾರರನ್ನು ಶಾಶ್ವತವಾಗಿ ತೆಗೆದುಹಾಕುತ್ತದೆ. ಇದನ್ನು ರದ್ದುಗೊಳಿಸಲಾಗದು.',
    yes_delete: 'ಹೌದು, ಅಳಿಸಿ', add_another: 'ಇನ್ನೊಂದು ಸೇರಿಸಿ', done_field_team: 'ಮುಗಿದಿದೆ — ತಂಡ',
    created_ok: 'ರಚಿಸಲಾಗಿದೆ', back: 'ಹಿಂದೆ',
    allow_special: 'ವಿಶೇಷ ಅನುಮತಿಸಿ', hide_special: 'ವಿಶೇಷ ಮರೆಮಾಡಿ', sees_special: 'ವಿಶೇಷ ನೋಡಬಹುದು',
    open_in_maps: 'ಗೂಗಲ್ ಮ್ಯಾಪ್‌ನಲ್ಲಿ ತೆರೆಯಿರಿ', access_label: 'ಪ್ರವೇಶ',
    permissions_label: 'ಅನುಮತಿಗಳು', see_mobile: 'ಮೊಬೈಲ್ ನೋಡಬಹುದು', see_special: 'ವಿಶೇಷ ಪಟ್ಟಿ ನೋಡಬಹುದು',
